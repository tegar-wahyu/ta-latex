...
\end{tikzpicture}%
  ...
  \caption{Topologi Ontologi: Relasi Struktural, Sekuensial Editorial,
    dan Semantik (Tier Ekstraksi) Beserta Inferensi Lintas-Buku
    (Tier Completion).}
  \label{fig:ontologi}
\end{figure}
  ...
  \begin{tabularx}{\textwidth}{@{}lX@{}}
    ...
    \texttt{ConceptTarget}
      & Konsep yang disebutkan sebagai target relasi dalam ekstraksi
        ...
        mencampurkan \textit{stub} tak-terdeskripsikan ke dalam
        populasi \texttt{Concept} formal. Tidak diembed dan tidak
...
dalam sumber---dan bukan urutan pembelajaran yang dipreskripsikan
bagi siswa.
...
\noindent\textit{Catatan.} Relasi berarah dalam-buku menyatakan
ketergantungan atau keterkaitan konseptual sebagaimana tersaji dalam
materi sumber, bukan urutan pembelajaran yang dipreskripsikan bagi
siswa.
...
\noindent\textit{Catatan.} Relasi \texttt{LINTAS\_BUKU\_*} merupakan
kandidat keterkaitan pedagogis \textit{single-hop} yang diusulkan
oleh tier \textit{completion} sebagai inferensi dangkal di atas Tier
ekstraksi. Setiap edge dinilai per-pasangan; sistem tidak
mengkomposisi edge-edge ini menjadi jalur belajar.
