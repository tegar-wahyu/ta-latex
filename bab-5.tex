...
\midrule
\endhead
ADC (seluruh \textit{node})                & 2{,}4123 & 2{,}6970 \\
...
\begin{enumerate}
  ...
  Berdasarkan Tabel~\ref{tab:struktural}, ADC seluruh \textit{node} meningkat dari 2{,}41
  ...
  lintas-buku baru yang secara langsung menghubungkan \textit{node} \texttt{Concept} antar-mapel,
