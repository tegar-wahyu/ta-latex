...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[fill=blue!60,   draw=blue!80]   coordinates {(A,57) (B,36) (C,18) (D,6)}; \addlegendentry{PRASYARAT\_UNTUK}
      \addplot[fill=green!55,  draw=green!75]  coordinates {(A,31) (B,20) (C,12) (D,4)}; \addlegendentry{MEMPERDALAM}
      \addplot[fill=purple!55, draw=purple!75] coordinates {(A,21) (B,5)  (C,2)  (D,0)}; \addlegendentry{BERKAITAN\_DENGAN}
      \addplot[fill=orange!75, draw=orange!90] coordinates {(A,15) (B,10) (C,9)  (D,3)}; \addlegendentry{APLIKASI\_DARI}
      \addplot[fill=red!55,    draw=red!75]    coordinates {(A,1)  (B,1)  (C,1)  (D,1)}; \addlegendentry{SAMA\_DENGAN}

      % Overlaid total line
      \addplot[
        mark=*, dashed, black, thick,
        mark options={fill=black, scale=0.9},
        nodes near coords,
