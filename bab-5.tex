...
inter-mapel (Fase 2). Data dianalisis menggunakan metrik \textit{Fuzzy
...
bertipe \texttt{BERKAITAN\_DENGAN}, dengan 8 di antaranya bahkan $< 0{,}5$---yang
...
\begin{itemize}
  \item Gerbang Logika Dasar [Fisika] $\leftrightarrow$ Notasi Sel Standar [Kimia]:
    \texttt{BERKAITAN\_DENGAN} (conf = 0{,}2). Relasi ini merupakan contoh \textit{false
  ...
  \item Klasifikasi Semikonduktor [Fisika] $\leftrightarrow$ Polimer Anorganik [Kimia]:
    \texttt{BERKAITAN\_DENGAN} (conf = 0{,}6). Kemiripan kemungkinan didorong oleh kesamaan
    konteks material/bahan, namun hubungan substantifnya lemah.
  \item Efek Fotolistrik [Fisika] $\to$ Fotosintesis [Biologi]:
    \texttt{MEMPERDALAM} (conf = 0{,}7). Keduanya melibatkan interaksi foton dengan
