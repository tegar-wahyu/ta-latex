...
\begin{enumerate}
  ...
  akibat 10 \textit{missing triples} yang tersisa pada konsensus final, dan
  pada Kimia Expert 2 (gap 10{,}9\%) akibat 29 \textit{missing triples} yang dilaporkan, 
  menandakan bahwa sistem masih luput mengekstrak sejumlah relasi kuantitatif dan 
  terminologi proses yang esensial. Diskrepansi tinggi antara Expert 1 dan Expert 2 
  Fisika (P: 0{,}997 vs.\ 0{,}870; R: 0{,}938 vs.\ 0{,}881) 
  mencerminkan perbedaan standar penilaian antar penilai--- suatu temuan yang dikonfirmasi 
  oleh nilai AC1 Fisika yang moderat (0{,}754).
...
Sebanyak 9 \textit{edge} memiliki \textit{confidence} $< 0{,}7$ (8 di antaranya
$< 0{,}5$, seluruhnya bertipe BERKAITAN\_DENGAN), yang mengindikasikan potensi
\textit{false positive}. Beberapa contoh relasi berkeyakinan rendah hingga
sedang ($\leq 0{,}7$) yang patut dicermati:
...
\textbf{Definisi yang terlalu luas.} Expert 2 (Fisika) mencatat sejumlah definisi yang
...
\textbf{Under-extraction formula dan rumus.} Expert 1 (Fisika) mengusulkan 15
...
% ──────────────────────────────────────────
\subsection{Analisis Koreksi dan Kategori Feedback}\label{subsubsec:feedback}
% ──────────────────────────────────────────

Dari 222 komentar yang diberikan Expert 1 (Fisika), analisis tematik
...
konfirmasi/klarifikasi terhadap total 222 komentar Expert 1 (Fisika), bukan
