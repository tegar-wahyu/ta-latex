...
\todo[inline,color=yellow!40]{[Siti Aminah] konsistensi disini maksudnya apa?}
...
\todo[inline,color=yellow!40]{[Siti Aminah] what is the meaning of faktualitas here?}
...
\todo[inline,color=yellow!40]{[Siti Aminah] jelaskan dan beri contoh pendekatan yg deterministik dan kaku! | balasan: âœ…}
...
\todo[inline,color=yellow!40]{[Siti Aminah] kelengkapan intrinsik maksudnya apa?}
...
\todo[inline,color=yellow!40]{[Tegar Wahyu] kasih penjelasan rumus @soros21febriano@gmail.com | balasan: }
...
\todo[inline,color=yellow!40]{[Soros] Kurang metrik: 5-point Likert scale | balasan: }
...
\todo[inline,color=yellow!40]{[Tegar Wahyu] choen kappa masukin metrik}
