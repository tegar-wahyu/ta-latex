...
yakni hanya melibatkan node \texttt{Concept} dan relasi langsung
antar-konsep, agar mencerminkan kepadatan interkoneksi materi sains tanpa
dipengaruhi oleh node struktural (kelas, bab, subbab). Untuk graf berarah,
...
\noindent dengan $|E_C|$ adalah jumlah relasi langsung antar-node
\texttt{Concept}, dan $|V_C|$ adalah jumlah node \texttt{Concept}. Penyebut
$|V_C|(|V_C|-1)$ merepresentasikan jumlah maksimum \textit{edge} berarah
yang mungkin ada antar-konsep, dari asumsi bahwa setiap pasangan node
