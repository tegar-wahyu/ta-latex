...
didefinisikan, terdapat 13 tipe relasi spesifik yang terbagi menjadi dua
kelompok: intra-buku (8 tipe, seperti \texttt{MENYEBABKAN} atau
...
\textit{zero-shot prompting} untuk ekstraksi dan \textit{few-shot
prompting} untuk klasifikasi relasi lintas-disiplin, serta (d)
