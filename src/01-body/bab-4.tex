...
\begin{enumerate}
  ...
  \item \textbf{Deteksi halaman TOC (daftar isi).} Halaman diklasifikasikan
        ...
        nomor halaman (mis.\ ``\texttt{..... 191}''). Gabungan kedua sinyal ini
...
\begin{enumerate}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=\maxwidth]{assets/pics/image5.png}
...
\begin{enumerate}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=\maxwidth]{assets/pics/image13.png}
