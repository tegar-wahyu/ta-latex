...
Untuk mengatasi fragmentasi pengetahuan tersebut, diperlukan representasi yang
mampu menampilkan hubungan antarkonsep secara eksplisit dan dapat ditelusuri.
Representasi semacam ini sulit dicapai melalui struktur dokumen kurikulum atau
buku teks konvensional yang bersifat linear.
...
memodelkan interkoneksi materi secara eksplisit. Dalam penelitian ini,
...
\textcite{kim_study_2023} mengajukan pendekatan KG untuk
...
yang paling bernilai pedagogis justru seringkali bersifat implisit, yaitu tidak
...
berhadapan dengan \textit{long-tail entities}, yaitu entitas yang memiliki sedikit
...
\begin{enumerate}
  ...
  \item \textbf{Batasan Inferensi Pedagogis:} Sistem hanya menginferensi
        ...
        menyusun jalur belajar multi-langkah lintas-disiplin, tidak
        memodelkan tingkat kognitif (taksonomi Bloom) maupun keadaan
        pembelajar (\textit{learner state}), dan tidak menghasilkan jalur
        belajar terkomposisi.
\end{enumerate}
