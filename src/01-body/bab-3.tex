...
\begin{enumerate}
  ...
  \item \textbf{Final consensus.} Berkas KG JSON awal, penilaian pakar,
        ...
        \textit{completion}, sedangkan Gemini~3.1 Pro Preview hanya digunakan
        pada kasus ketidaksepakatan pakar yang membutuhkan penalaran lebih
        hati-hati.

        Untuk mengurangi risiko bias validasi diri, \textit{triple} hasil
        ...
        validasi, masukan mencakup \textit{triple} yang diperselisihkan, dua
        ...
        reproduksi metrik, analisis galat, dan uji ketahanan. Untuk pemanfaatan
