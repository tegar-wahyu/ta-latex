...
\begin{itemize}
  \item \textbf{Objek yang divalidasi.} Pada Fase~1, objek penilaian adalah
        ...
        (lintas-disiplin) hasil KGC, yakni 117 relasi kandidat yang lolos
        penyaringan \textit{confidence} $\geq 0{,}5$ dari 125 \textit{edge}
        keluaran \textit{pipeline} pada konfigurasi final---8 \textit{edge}
        berkeyakinan rendah dikecualikan dari survei utama.
