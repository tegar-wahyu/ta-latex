...
Fuzzy Precision, Recall, dan F1-Score, sedangkan dua penilaian asli tersebut
...
\begin{enumerate}
  ...
  \item \textbf{Final consensus.} Berkas KG JSON awal, penilaian pakar,
        ...
        Ketidaksepakatan antarpakar diajudikasi dengan
        \textit{LLM-as-a-judge} berbasis konteks sumber; rincian alur
        ajudikasi ditunjukkan pada Gambar~\ref{fig:llm-judge}. Hasil
        ...
        dari pasangan penilaian pakar, sedangkan Precision, Recall, dan F1-Score
