...
terhitung penuh karena Buku Guru Biologi berupa PDF hasil pindai tanpa lapisan
teks; estimasi parsial dari dua buku guru lainnya adalah sekitar 79.300 kata.
...
\textsuperscript{*}~Buku Guru Biologi (\texttt{Biologi\_BG\_KLS\_XII.pdf})
berupa PDF hasil pindai (\textit{scan}) tanpa lapisan teks, sehingga jumlah
katanya tidak dapat diekstraksi; ke-264 \textit{chunk}-nya berkorespondensi
satu-ke-satu dengan halaman dan tidak memuat teks.
\textsuperscript{+}~Total kata Buku Guru merupakan estimasi parsial dari Fisika
dan Kimia saja. Kolom Bab dan Subbab tidak dipisah Siswa/Guru karena merujuk
pada struktur daftar isi Buku Siswa.\par}
\end{minipage}
\end{table}
