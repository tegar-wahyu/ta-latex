...
Ontologi dikembangkan secara iteratif dengan mengacu pada panduan praktis
\textit{Ontology Development 101} \parencite{noy_ontology_2001}, yang
diadaptasi ke dalam konteks konstruksi berbantuan-LLM. Strategi yang ditempuh
bersifat \textit{middle-out}: kerangka kelas disusun secara \textit{top-down}
dari struktur dokumen sumber, sedangkan vokabulari relasi semantik ditetapkan
sebagai himpunan target dan disempurnakan secara iteratif. Sesuai posisinya
sebagai ontologi ringan pada spektrum formalitas
...
penalaran berat yang tidak diperlukan oleh tujuan penelitian. Tahapan
pengembangan memetakan tujuh langkah \textcite{noy_ontology_2001} sebagai
berikut.
...
\begin{enumerate}
  ...
  \item \textbf{Definisi properti:} lima belas tipe relasi dalam-buku
        ditetapkan sebagai vokabulari tertutup yang merepresentasikan kategori
        relasi ilmiah umum (kausal, komposisional, fungsional, definisional,
        dan sebagainya), didampingi properti data seperti \texttt{description}
        (sumber \textit{embedding}), \texttt{glossary\_validated}, dan
...
Berbeda dari penerapan klasik \textcite{noy_ontology_2001} yang menyusun
ontologi secara manual dan \textit{top-down}, langkah~3 dan~7 di sini bersifat
\textit{bottom-up}: terminologi dan instans diturunkan dari teks oleh LLM,
sehingga ontologi berperan sebagai spesifikasi target yang sekaligus memandu
dan disempurnakan oleh hasil ekstraksi.
...
Penegakan vokabulari relasi dilakukan pada tataran instruksi \textit{prompt}
(Lampiran~\ref{lamp:prompt-ekstraksi}) dan tidak bersifat kaku pada level
skema, sehingga sebagian kecil keluaran LLM dapat menyimpang dari himpunan tipe
yang dideklarasikan; penyimpangan tersebut dikonsolidasikan pada tahap
konsensus dan dicatat sebagai keterbatasan penelitian (Bab~6).
