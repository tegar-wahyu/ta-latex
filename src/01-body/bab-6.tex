...
\begin{enumerate}
  \item \textbf{Representasi eksplisit interkoneksi kurikulum.}
        ...
        konfigurasi penelitian ini, meskipun belum dimaksudkan sebagai peta
        kurikulum yang lengkap untuk seluruh fase atau jenjang.
  ...
  \item \textbf{Perubahan kualitas struktural KG sebelum dan sesudah completion.}
        ...
        penambahan \textit{edge} KGC. Bukti topologis ini
  ...
  \item \textbf{Validitas relasi dan keandalan evaluasi.}
        ...
        dengan catatan bahwa normalisasi arah relasi masih menjadi kelemahan
