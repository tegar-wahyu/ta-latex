...
\begin{enumerate}
  \item \textbf{Pemetaan interkoneksi untuk mengatasi \textit{siloed learning}.}
        ...
        ketiga komunitas disiplin yang semula terpisah. Uji ketahanan dengan
  ...
  \item \textbf{Pemanfaatan kemampuan semantik LLM untuk melengkapi relasi
        ...
        pun tetap memperoleh kandidat relasi yang bermakna. Pendekatan ini berhasil
        menemukan relasi lintas-disiplin implisit yang valid (validitas 99{,}1\%),
  ...
  \item \textbf{Validitas relasi lintas-disiplin menurut pakar dan peningkatan
        ...
        topologis pada poin~(1). Sistem unggul dalam \textit{menemukan} dan
        \textit{melabeli} relasi implisit, namun memiliki kelemahan sistematis
...
terdokumentasi---memenuhi tujuan penelitian dan menjadi salah satu sumber daya
data terbuka berbahasa Indonesia bagi pengembang kurikulum dan peneliti teknologi
