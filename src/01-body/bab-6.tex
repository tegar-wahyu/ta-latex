...
\begin{enumerate}
  \item \textbf{Pemetaan interkoneksi untuk menjembatani fragmentasi penyajian kurikulum.}
        ...
        0{,}666 yang merefleksikan kondisi \textit{siloed learning}. Setelah
        penambahan 125 relasi lintas-buku, \textit{Modularity} turun menjadi
        0{,}158, sementara \textit{Average Degree} (AD) meningkat
        ...
        sama: AD tetap meningkat dari 0{,}7093 menjadi 1{,}4360, densitas dari
        0{,}00103 menjadi 0{,}00209, dan \textit{Modularity} turun dari 0{,}6654
        menjadi 0{,}1489.
...
merupakan metode yang layak (\textit{viable}) --- pada korpus dan konfigurasi
yang diuji, tanpa pembanding baseline --- untuk membangun dan melengkapi graf
...
\begin{enumerate}
  ...
  \item \textbf{Ketiadaan baseline pembanding.} Klaim bahwa pendekatan berbasis
