...
standar W3C untuk merepresentasikan ontologi yang menyediakan konstruk formal
guna mendefinisikan kelas (\textit{class}), relasi antar-entitas
(\textit{object property}), serta properti data (\textit{datatype property})
\parencite{w3c_owl2_2012}. Di sini OWL digunakan sebagai format penulisan skema
yang baku dan dapat dibaca mesin, bukan untuk memanfaatkan seluruh kemampuan
logika formalnya. Dengan kata lain, OWL dipakai untuk menuliskan struktur
ontologi, sementara model yang dibangun tetap sederhana dan bersifat taksonomik,
sehingga selaras dengan pendekatan ontologi informal yang telah diuraikan.
