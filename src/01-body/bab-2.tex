...
Modularity membandingkan jumlah \textit{edge} yang benar-benar ada dalam
komunitas dengan jumlah \textit{edge} yang secara statistik diharapkan muncul
apabila koneksi antar-\textit{node} disebar secara acak dengan distribusi
\textit{degree} dipertahankan. Dalam penelitian ini, \textit{modularity}
dihitung menggunakan algoritma deteksi komunitas \textit{Louvain}
\parencite{blondel_fast_2008} yang tersedia pada pustaka \textit{Graph Data
Science} (GDS) Neo4j. Algoritma ini mengidentifikasi komunitas secara otomatis
dengan memaksimalkan $Q$, lalu melaporkan nilai $Q$ akhir beserta jumlah
komunitas yang terbentuk. Nilai $Q$ dan jumlah komunitas pada graf pre-KGC dan
post-KGC dibandingkan untuk menilai perubahan struktur komunitas akibat
penambahan relasi lintas-buku; kueri GDS yang digunakan disajikan pada
\ref{lamp:cypher}.
