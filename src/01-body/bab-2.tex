...
menjadi komunitas-komunitas yang terpisah. Nilai yang lebih tinggi
menunjukkan pemisahan komunitas yang lebih tegas, ditandai dengan koneksi
yang rapat di dalam komunitas dan lebih jarang di luar komunitas. Dalam
konteks penelitian ini, arah perubahan yang diharapkan adalah
...
didefinisikan oleh Leicht dan Newman \parencite{leicht_community_2008} sebagai:
...
Dalam penelitian ini, partisi komunitas $c$ diperoleh melalui algoritma
deteksi komunitas \textit{Louvain} pada Neo4j Graph Data Science Plugin. Dengan demikian, nilai
$Q$ pre-KGC dan post-KGC mencerminkan struktur komunitas yang ditemukan
algoritma pada masing-masing kondisi graf. Perbandingan kedua nilai tersebut
digunakan untuk menilai apakah penambahan \textit{edge} lintas-mata-pelajaran
melalui proses KGC mengubah keterpisahan komunitas dalam graf.
