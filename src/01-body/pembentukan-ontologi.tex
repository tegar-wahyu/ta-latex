...
\begin{enumerate}
  ...
  \item \textbf{Mempertimbangkan penggunaan-ulang ontologi yang ada.} Belum ada
        ontologi kurikulum Indonesia yang sesuai, sehingga ontologi dibangun
        \textit{purpose-built} dan sengaja dijaga \textit{lightweight} --- rendah
        pada spektrum formalitas (Gambar~\ref{fig:spektrum-ontologi}), cukup
        formal sebagai spesifikasi tanpa beban aksioma berat yang tidak
        dibutuhkan.
  ...
  \item \textbf{Mendefinisikan \textit{facet} slot.} Setiap properti objek
  ...
  \item \textbf{Membuat instans.} Ontologi dipopulasikan oleh konsep dan relasi
