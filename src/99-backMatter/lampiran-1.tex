% ============================================================
%  LAMPIRAN 1 - ARSITEKTUR KG REVIEW APP
%  Compile standalone:  pdflatex lampiran-1.tex
...
\lampiran{Arsitektur KG Review App}
...
Fase~2). Versi langsung aplikasi ini dapat diakses pada
\url{https://kg-review-app.vercel.app/explore}.
...
% ------------------------------------------------------------------
\subsection{Tangkapan Layar Antarmuka}
