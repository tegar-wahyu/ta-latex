...
% ── Bibliography (only used for standalone compilation) ──────
\usepackage[
  backend = biber, style = authoryear,
  maxcitenames = 2, mincitenames = 1, maxbibnames = 99,
  giveninits = true, dashed = false, doi = false, isbn = false, url = false
]{biblatex}
\addbibresource{references.bib}
\renewcommand*{\finalnamedelim}{\addspace dan\addspace}
