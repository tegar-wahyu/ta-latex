...
\todo[inline,color=yellow!40]{[Soros Febriano 2206083445] https://www.colegioeuropeodemadrid.com/en/blog/meaningful-learning-its-characteristics-and-benefits/}
...
\todo[inline,color=yellow!40]{[Soros Febriano 2206083445] https://www.tieonline.com/article/3699/de-siloing-education}
...
\todo[inline,color=yellow!40]{[Siti Aminah] kalau sudah pernah bikin singkatan KG nggak perlu ditulis berulang kali Knowldege Graph (KG)}
...
sebagai \textit{triple} (Fotosintesis, MENGHASILKAN, Glukosa).
...
\todo[inline,color=yellow!40]{[Siti Aminah] mengapa huruf depan tiap kata kapital?}
...
\todo[inline,color=yellow!40]{[Siti Aminah] bahasa iklan nih, bukan bahasa ilmiah. dan jelaskan solusi apa yang dimaksud disini | balasan: }
...
\todo[inline,color=yellow!40]{[Siti Aminah] isi dari ruang lingkup juga perlu to the point. jangan mengulang yg sudah ditulis sebelumnya. | balasan: âœ…}
...
\todo[inline,color=yellow!40]{[Siti Aminah] tujuan khusus no 2 dan 3 apa bedanya? | balasan: âœ…}
...
\todo[inline,color=yellow!40]{[Tegar Wahyu] review setelah update | balasan: }
...
\todo[inline,color=yellow!40]{[Siti Aminah] isi dari subbab 1.4 tampak fully AI generated ya? agak bertele-tele, tidak to the point dan banyak mengulang hal-hal yang sudah disampaikan pada subbab sebelumnya. Tolong diperingkas dan tulis dengan bahasa sendiri!}
% ============================================================
